...
* # [puppetlabs/puppetlabs-inifile](https://github.com/puppetlabs/puppetlabs-inifile)
    * [pdksync - (PDKSync) Removal of puppet_module_gems](https://github.com/puppetlabs/puppetlabs-inifile/pull/491)
* # [puppetlabs/puppetlabs-java](https://github.com/puppetlabs/puppetlabs-java)
    * [pdksync - (PDKSync) Removal of puppet_module_gems](https://github.com/puppetlabs/puppetlabs-java/pull/529)
* # [puppetlabs/puppetlabs-java_ks](https://github.com/puppetlabs/puppetlabs-java_ks)
    * [pdksync - (PDKSync) Removal of puppet_module_gems](https://github.com/puppetlabs/puppetlabs-java_ks/pull/416)
* # [puppetlabs/puppetlabs-kubernetes](https://github.com/puppetlabs/puppetlabs-kubernetes)
    * [pdksync - (PDKSync) Removal of puppet_module_gems](https://github.com/puppetlabs/puppetlabs-kubernetes/pull/580)
* # [puppetlabs/puppetlabs-motd](https://github.com/puppetlabs/puppetlabs-motd)
    * [pdksync - (PDKSync) Removal of puppet_module_gems](https://github.com/puppetlabs/puppetlabs-motd/pull/452)
* # [puppetlabs/puppetlabs-mysql](https://github.com/puppetlabs/puppetlabs-mysql)
    * [pdksync - (PDKSync) Removal of puppet_module_gems](https://github.com/puppetlabs/puppetlabs-mysql/pull/1497)
...
* # [puppetlabs/puppetlabs-package](https://github.com/puppetlabs/puppetlabs-package)
    * [pdksync - (PDKSync) Removal of puppet_module_gems](https://github.com/puppetlabs/puppetlabs-package/pull/291)
