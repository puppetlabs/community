...
* # [puppetlabs/puppetlabs-apache](https://github.com/puppetlabs/puppetlabs-apache)
    * [Release prep v8.3.0](https://github.com/puppetlabs/puppetlabs-apache/pull/2341)
...
* # [puppetlabs/puppetlabs-docker](https://github.com/puppetlabs/puppetlabs-docker)
    * [docker_run_flags: Shellescape any provided values](https://github.com/puppetlabs/puppetlabs-docker/pull/867)
...
* # [puppetlabs/puppetlabs-kubernetes](https://github.com/puppetlabs/puppetlabs-kubernetes)
    * [add Feature ](https://github.com/puppetlabs/puppetlabs-kubernetes/pull/583)
* # [puppetlabs/puppetlabs-motd](https://github.com/puppetlabs/puppetlabs-motd)
    * [Update rubocop requirement from = 1.6.1 to 1.37.1](https://github.com/puppetlabs/puppetlabs-motd/pull/458)
...
* # [puppetlabs/puppetlabs-mysql](https://github.com/puppetlabs/puppetlabs-mysql)
    * [mysql::db sql parameter support filenames with multiple dots](https://github.com/puppetlabs/puppetlabs-mysql/pull/1505)
    * [fix for issue #1502](https://github.com/puppetlabs/puppetlabs-mysql/pull/1503)
...
* # [puppetlabs/puppet_litmus](https://github.com/puppetlabs/puppet_litmus)
    * [(GH-463) Fix spec tests](https://github.com/puppetlabs/puppet_litmus/pull/464)
