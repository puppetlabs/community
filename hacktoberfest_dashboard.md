...
* # [puppetlabs/puppetlabs_spec_helper](https://github.com/puppetlabs/puppetlabs_spec_helper)
    * [Update rubocop-rspec requirement from ~> 2.0.1 to ~> 2.4.0](https://github.com/puppetlabs/puppetlabs_spec_helper/pull/362)
    * [Update rubocop-performance requirement from ~> 1.9.1 to ~> 1.10.2](https://github.com/puppetlabs/puppetlabs_spec_helper/pull/361)
    * [(CONT-237) Rubocop updates](https://github.com/puppetlabs/puppetlabs_spec_helper/pull/360)
